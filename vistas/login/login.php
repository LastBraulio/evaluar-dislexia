...
<head>
  ...
  <title>Pages / Login - ProEdu</title>
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post">
                   ...
                   <div class="col-12">
                    ...
                    <div class="col-12">
                      <button name="logeado" class="btn btn-primary w-100" type="submit">Login</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="login.php?v=registro">Create an account</a></p>
                    </div>
                  </form>
